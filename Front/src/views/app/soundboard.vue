...
<template>
    <div id="bod" @click="displayMenu.active = false" :style="styleBackground">
        <div id="top_part">
            <div id="mainBar">
                ...
                <div id="btnContainer">
                    ...
                    <label id="add" class="btn" title="Ajouter un son" @click="showPopup()"> 
        ...
        <div class="bckgPopup" v-if="displayPopup">
            <div id="AddPopUp"> 
                
                <div id="closePopup" @click="hidePopup()">
                ...
                <button class="formbutton" id="Ajouter" @click="add()"> Ajouter </button>
            </div>     
        </div>
    </div>
