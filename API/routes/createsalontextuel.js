...
const { hasLetterOrNumber } = require('../../BOT/functions')
...
router.post('/channel', async (req, res) => {
  try {
    ...
    //--
    await functions.createsalontextuel(req.body.guildID, req.body.categoryID, channelName)

    //-- Création du log
    const newlog = new logs();
    newlog.action = "CREATE_SALON_TEXTUEL";
    ...
    const response = {action: "CREATE_SALON_TEXTUEL", username: name, discriminator: discriminator, guildID : req.body.guildID, nom_salon: channelName, time: time}
