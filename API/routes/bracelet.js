...
router.post('/role', async (req, res) => {
  try {
    ...
    const user2 = await discord.client.users.fetch(req.body.userbraceletID)
    ...
    //--
    await functions.bracelet(req.body.guildID, req.body.userbraceletID, req.body.roleID)

    //-- Création du log
    const newlog = new logs();
    newlog.action = "BRACELET";
    ...
    const response = {action: "BRACELET", username: name, discriminator: discriminator, guildID : req.body.guildID, username2: name2, discriminator2: discriminator2, time: time}
