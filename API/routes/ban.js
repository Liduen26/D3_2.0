...
router.post('/user', async (req, res) => {
  try {
    ...
    const user2 = await discord.client.users.fetch(req.body.banuserID)
    ...
    await functions.ban(req.body.banuserID, req.body.guildID, reason)
    ...
    const response = {action: "BAN", username: name, discriminator: discriminator, guildID: req.body.guildID, username2: name2, discriminator2: discriminator2, reason: reason, time: time}
